...
\begin{frame}
\frametitle{Parallele Ansätze -- Gauß-Seidel-RotSchwarz}
TODO: Berechnung der Indizes, Optimierungen
\end{frame}
...
\begin{center}
\includegraphics[scale=0.28]{images/tabelle_auswertung_ohne.png}
\end{center}
\end{frame}
...
\frametitle{Auswertung mit Abbruchkriterium}
\begin{center}
\includegraphics[scale=0.2]{images/bild_auswertung_mit.png}
\end{center}
\end{frame}
...
\frametitle{Auswertung mit Abbruchkriterium}
\begin{center}
\includegraphics[scale=0.2]{images/bild_auswertung_ohne.png}
\end{center}
\end{frame}
