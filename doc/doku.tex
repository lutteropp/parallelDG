...
Die folgenden Messungen sind vielleicht nicht ganz fair, weil die parallelen Versionen mit SSE beschleunigt wurden und die Seriellen nicht. Die Werte für Größen unter 128 sind sehr Fehleranfällig, weil sie so klein sind, und fast unbrauchbar.
\begin{figure}[h] 
  \centering
...
\begin{figure}[h] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/sn7129.png}
  \caption{Ergebnisse der Messung auf sn07 (32 Kerne)}
\end{figure}
\begin{figure}[h] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/sn7513.png}
  \caption{Ergebnisse der Messung auf sn07 (32 Kerne)}
\end{figure}
\begin{figure}[h] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/sn71025.png}
  \caption{Ergebnisse der Messung auf sn07 (32 Kerne)}
\end{figure}
