...
\hline 
Sequentiell & 0.133 s & - &  0.133 s & - &  0.133 s & -  \\
\hline
OpenMP + SSE & 0,034 s & 3,324 & 0,02 s & 5,65 & 0,0322 s & 3,531  \\ 
\hline 
\end{tabular}
\caption{Speedup-Messungen für verschiedene Parallelisierungen des Jacobi-Verfahrens für $h=\frac{1}{64}$.}
\end{table}
...
\hline 
 & Laufzeit & Speedup & Laufzeit & Speedup & Laufzeit & Speedup  \\ 
\hline 
Sequentiell & 1,4 s & - &  1,4 s & - & 1,4 s & -  \\
\hline
OpenMP + SSE & 0,4 s & 3,5 & 0,145 s & 9,655 & 0,135 s & 10,37  \\ 
\hline 
\end{tabular}
\caption{Speedup-Messungen für verschiedene Parallelisierungen des Jacobi-Verfahrens für $h=\frac{1}{128}$.}
\end{table}
...
\hline 
 & Laufzeit & Speedup & Laufzeit & Speedup & Laufzeit & Speedup  \\ 
\hline 
Sequentiell & 14,8 s & - &  14,8 s & - &  14,8 s & -  \\
\hline
OpenMP + SSE & 4,3 s & 3,442 & 1,28 s & 11,563 & 0,75 s & 2,47  \\ 
\hline 
\end{tabular}
\caption{Speedup-Messungen für verschiedene Parallelisierungen des Jacobi-Verfahrens für $h=\frac{1}{256}$.}
\end{table}
