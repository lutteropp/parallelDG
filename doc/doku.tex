...
Sind alle in den Tabellen von \ref{ergebnisse}
\subsection{Approximationsfehler}
Wir haben den Approximationsfehler nur für $size=4$ und $size=32$ dargestellt, weil Open Office nicht genug Punkte verarbeiten kann. Die Aussage sollte aber auch für größere Werte gleich sein.
\begin{figure}[htbp] 
  \centering
...
Im Fall des Gauß-Seidel-Verfahrens tritt dies in folgendem Beispiel auf :
...
\begin{figure}[h] 
  ...
  \caption{Die Racecondition in Gaus-Seidel mit naiver Parallelisierung. Es wird gemeinsam auf a1 gelesen und geschrieben.}
\end{figure}
...
Da die Matrixeinträge gleicher Farbe nicht voneinander abhängen, können wir diese parallel berechnen. Dies führt zu folgendem Ansatz: 
\begin{figure}[h] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/rspseudocode.png}
  \caption{Pseudocode einer Rot-Schwarz Implementierung aus der Vorlesung Heterogene parallele Rechensysteme.}
\end{figure}
