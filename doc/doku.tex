...
TODO: Siehe z.B. hier: \url{http://www.mathematik.uni-muenchen.de/~lerdos/SS08/Num/9.pdf}
...
$$u^{(n)} = -D^{-1}(L+R)  u^{(n-1)} + D^{-1}b$$
$$\Leftrightarrow u^{(n)} = D^{-1}  \left(b -(L+R)  u^{(n-1)}\right)$$

Oder elementweise:
$$u_i^{(n)} = \frac{1}{a_{i,i}} * (b_i - \sum_{j \neq i}{a_{ij} u_j^{(n-1)}}) \quad \forall i = 1, \ldots, size$$

Der Startvektor $u^{(0)}$ kann hierbei beliebig gewählt werden und es gilt, dass $D$ invertierbar sein muss. Dies ist jedoch bei unserer Aufgabenstellung der Fall, da $a_{i,i} = 4$ ist für alle $i = 1, \ldots, size$.
...
\begin{figure}[htbp] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/sn023.png}
  \caption{Performance für size=3 auf sn02(8 Kerne).}
 
\end{figure}
\begin{figure}[htbp] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/sn025.png}
  \caption{Performance für size=5 auf sn02(8 Kerne).}
...
\begin{figure}[htbp] 
  ...
  \caption{Performance für size=32 auf sn02(8 Kerne).}
 
\end{figure}
\begin{figure}[htbp] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/sn0265.png}
  \caption{Performance für size=65 auf sn02(8 Kerne).}
 
\end{figure}
\begin{figure}[htbp] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/sn02128.png}
  \caption{Performance für size=128 auf sn02(8 Kerne).}
 
\end{figure}
\begin{figure}[htbp] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/sn02256.png}
  \caption{Performance für size=256 auf sn02(8 Kerne).}
 
\end{figure}
\begin{figure}[htbp] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/sn073.png}
  \caption{Performance für size=3 auf sn07(12 Kerne).}
 
\end{figure}
\begin{figure}[htbp] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/sn075.png}
  \caption{Performance für size=5 auf sn07(12 Kerne).}
 
\end{figure}
\begin{figure}[htbp] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/sn0732.png}
  \caption{Performance für size=32 auf sn07(12 Kerne).}
 
\end{figure}
\begin{figure}[htbp] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/sn0765.png}
  \caption{Performance für size=65 auf sn07(12 Kerne).}
 
\end{figure}
\begin{figure}[htbp] 
  \centering
     \includegraphics[width=1.0\textwidth]{bilder/sn07128.png}
  \caption{Performance für size=128 auf sn07(12 Kerne).}
...
\begin{figure}[htbp] 
  ...
  \caption{Performance für size=1024 auf sn02(8 Kerne). Ab hier macht Wavefront zumindest etwas sinvolles. Der lauf lief nur bis 10000 Iterationen und nicht bis zum Abbruchkriterium, weil sonst zu lange dauert(alles nicht nur wavefront).}
